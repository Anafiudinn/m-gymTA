    ...
    <div style="width:100%;
        ...
        <div style="padding:20px 24px;
            ...
            <div>
                ...
                <h3 id="trackPackageName"
                    style="font-family:'Barlow Condensed','Barlow',sans-serif;
                           font-weight:900;
                           font-size:22px;
                           color:#fff;
                           letter-spacing:.04em;
