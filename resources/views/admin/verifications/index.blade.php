...
{{-- Flash alerts --}}
@if(session('success'))
<div class="flash success"><i class="fa fa-circle-check" style="margin-right:6px;"></i>{{ session('success') }}</div>
@endif

@if(session('error'))
<div class="flash error"><i class="fa fa-circle-xmark" style="margin-right:6px;"></i>{{ session('error') }}</div>
@endif
