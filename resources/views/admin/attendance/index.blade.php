    ...
    <div style="background:#fff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;">
        ...
        @if($attendanceHistory->isEmpty())
            ...
            <div style="display:flex;flex-direction:column;
                ...
                <p style="font-size:13px;color:#9ca3af;font-weight:500;margin:0;">
        ...
        @else
            {{-- ═══ SUMMARY CARDS ═══ --}}
            @php
                $totalGuest = $attendanceHistory
                    ->whereIn('type', ['guest', 'paid_visit'])
                    ->count();

                $totalMember = $attendanceHistory
            ...
            <div style="display:grid;
                ...
                <div style="background:#fff;padding:14px 18px;text-align:center;">
                    <p style="font-size:10.5px;font-weight:700;color:#9ca3af;
                              text-transform:uppercase;letter-spacing:.06em;
                              margin:0 0 4px;">
                        Tamu / Visit
                    </p>
                    <p style="font-size:20px;font-weight:800;color:#f97316;margin:0;">
                        {{ $totalGuest }}
                    </p>
                </div>
                ...
                <div style="background:#fff;padding:14px 18px;text-align:center;">
                    ...
                    <p style="font-size:20px;font-weight:800;color:#2563eb;margin:0;">
                        {{ $totalMember }}
                    </p>
                </div>
                ...
                <div style="background:#fff;padding:14px 18px;text-align:center;">
                    ...
                    <p style="font-size:16px;font-weight:800;color:#111827;margin:0;">
                    ...
                    <div style="display:flex;align-items:center;
                        ...
                        <div style="display:flex;align-items:center;gap:12px;">
                            ...
                            <div>
                                <p style="font-size:13.5px;font-weight:700;
                                    ...
                                    {{ $isGuest
                                        ? ($item->guest_name ?? 'Tamu Umum / Guest')
                        ...
                        <div style="display:flex;align-items:center;gap:14px;flex-shrink:0;">
                            ...
                            <div style="text-align:right;">
                                ...
                                @else
                                    ...
                                    <span style="display:inline-flex;
                                                 ...
                                                 margin-top:2px;">
                                        <i class="fa {{ $isGuest ? 'fa-money-bill-wave' : 'fa-id-card' }}"
                            ...
                            <div style="text-align:right;">
                                ...
                                <p style="font-size:10.5px;color:#9ca3af;margin:2px 0 0;">
                                    WIB
                                </p>
                            </div>
                            ...
                            <div style="width:28px;height:28px;border-radius:50%;
                                ...
                                <i class="fa fa-check"
                                   style="font-size:10px;color:#16a34a;"></i>
                            </div>
                        </div>
                    </div>
