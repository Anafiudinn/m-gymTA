    ...
    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <form method="GET" class="flex flex-col sm:flex-row flex-wrap gap-3 w-full lg:w-auto">
            ...
            <select
                ...
                <option value="retail" {{ request('category') == 'retail' ? 'selected' : '' }}>
                    Retail
                </option>

                <option value="activation" {{ request('category') == 'activation' ? 'selected' : '' }}>
                    Aktivasi
                </option>

                <option value="monthly" {{ request('category') == 'monthly' ? 'selected' : '' }}>
                    Membership
                </option>

                <option value="pt" {{ request('category') == 'pt' ? 'selected' : '' }}>
                    Personal Trainer
                </option>

                <option value="visit" {{ request('category') == 'visit' ? 'selected' : '' }}>
                    Visit Harian
                </option>
            </select>
            ...
            <select
                ...
                <option value="onsite" {{ request('source') == 'onsite' ? 'selected' : '' }}>
                    Onsite
                </option>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-blue-600 mt-2">
                {{ $transactions->where('category', 'retail')->count() }}
            </h3>
        </div>
        ...
        <div class="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm">
            ...
            <h3 class="text-2xl font-extrabold text-emerald-600 mt-2">
                {{ $transactions->where('category', 'monthly')->count() }}
            </h3>
        </div>
        ...
        <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-1">
                    Histori pembayaran gym dan retail.
                </p>
            </div>
        </div>
                ...
                <tbody class="divide-y divide-slate-100">
                    ...
                    <tr class="hover:bg-slate-50/70 transition-all">
                        ...
                        <td class="px-6 py-5">
                            ...
                            <div>
                                <h4 class="font-semibold text-slate-700 uppercase">
                                    {{ $trx->payment_method }}
                                </h4>
                            </div>
                        ...
                        <td colspan="8" class="py-24 text-center">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <p class="text-sm text-slate-400 mt-1">
                                    Histori transaksi akan muncul di sini.
                                </p>
...
<div
    id="detailModal"
    class="hidden fixed inset-0 bg-slate-900/60 backdrop-blur-sm z-[70] flex items-center justify-center p-4">
    ...
    <div class="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-slate-100 flex items-center justify-between">
            ...
            <div>
                ...
                <p class="text-sm text-slate-400 mt-1" id="modal_invoice">
                    -
                </p>
            </div>
            ...
            <button
                ...
                class="w-10 h-10 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-500 transition-all">
        ...
        <div class="p-8 space-y-6">
            ...
            <div id="modal_reject" class="hidden bg-red-50 border border-red-100 rounded-2xl p-4">
                ...
                <p class="text-xs text-red-400 uppercase tracking-widest font-bold mb-2">
                    Alasan Rejected
                </p>

                <p id="modal_reject_reason" class="text-sm text-red-600 font-medium">
                    -
                </p>
    ...
    trx.items.forEach(item => {
        ...
        html += `
            <div class="bg-slate-50 rounded-2xl p-4 flex items-center justify-between">
                ...
                <h5 class="font-extrabold text-blue-600">
                    Rp ${item.subtotal}
                </h5>
